...
const Hero1 = () => {
  return (
    <div className='bg-cover bg-center h-screen' style={{backgroundImage:"url(/images/.jpg)"}}>
            <div>
            ...
            <p data-aos="zoom-in-up" className='text-center text-black  pt-4  text-3xl'>Meet me I am Shahjarar Khan</p>
            </div>
            <div>
                <Image src="/images/Scanner.jpg"
                width={400}
                height={400}
                alt="rabia"
                data-aos="zoom-in-up"
